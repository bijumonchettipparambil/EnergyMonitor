...
/**
  ...
  Global state variable for logging framework, defaulted to level INFO.
...
/**
  ...
  Text labels for logging levels supported by the logging framework.
...
/**
  ...
  Convert an enum to the corresponding text label.
...
/**
  ...
  Check if the current the message log level is within the current log level.
